...
class Content_Models_LinkSectionMapLang extends Models_DbTable 
{
    protected $_name = 'link_section_map_lang';
    public $lastID;
    ...
    public function getLanguagesWithSection($where,$orderBy = null,$fetchMode = Zend_Db::FETCH_OBJ){
    	...
    	$sql = "SELECT 
    			...
    			L.title
    			FROM $this->_name L 
    			JOIN link_section_map LL ON (L.linkSectionMapID = LL.linkSectionMapID)
