...
class Content_Models_RelatedArticle extends Models_DbTable
{
    protected $_name = 'related_article';
    public $lastID;
    ...
    public function getAllRelated($id){
    	
    	$sql = "SELECT A.articleID, A.title 
            	FROM article A JOIN related_article RA ON(A.articleID = RA.relatedArticleID)
            	WHERE RA.articleID = ?
