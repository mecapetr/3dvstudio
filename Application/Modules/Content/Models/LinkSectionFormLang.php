...
class Content_Models_LinkSectionFormLang extends Models_DbTable 
{
    protected $_name = 'link_section_form_lang';
    public $lastID;
    ...
    public function getLanguagesWithSection($where,$orderBy = null,$fetchMode = Zend_Db::FETCH_OBJ){
    	...
    	$sql = "SELECT 
    			LS.linkSectionID,
    			LL.linkSectionFormID,
    			L.lang,
    			L.title,
    			L.niceTitle
    			FROM $this->_name L 
    			JOIN link_section_form LL ON (L.linkSectionFormID = LL.linkSectionFormID)
