...
class Eshop_Models_PaymentType extends Models_DbTable
{
    ...
    public function getAllPayments($lang){
    	...
    	$sql = "SELECT PTL.title, PT.paymentTypeID
        	    			
        	    FROM $this->_name PT
        	    JOIN payment_type_lang PTL ON (PT.paymentTypeID = PTL.paymentTypeID AND PTL.lang = ?)
        	    
        	    WHERE PT.lang = '' OR PT.lang = ?
        ";
