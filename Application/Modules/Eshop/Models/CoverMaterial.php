...
class Eshop_Models_CoverMaterial extends Models_DbTable
{
    protected $_name = 'cover_material';
    public $lastID;
    ...
    public function getAllMaterials($lang){
    	
    	$sql = "SELECT CML.title, CM.coverMaterialID
    	    	        
    	    	FROM $this->_name CM
    	    	JOIN cover_material_lang CML ON (CML.coverMaterialID = CM.coverMaterialID AND CML.lang = ?)
    	";
